...
const MenuPositionForm: FC<MenuPositionFormProps> = ({}) => {
  ...
  const onSubmit: SubmitHandler<FormSchema> = (data: any) => {};

  return (
    <div className="px-4 pb-5 border border-[#EAECF0] rounded-lg flex flex-col gap-2 justify-center items-center bg-white mt-[30px] w-full">
